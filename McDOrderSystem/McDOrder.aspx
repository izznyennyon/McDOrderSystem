    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="column rightColumn">
                ...
                <p>
                    <asp:Button ID="btnComfirm" runat="server" Text="Confirm Sales" OnClick="btnComfirm_Click" />&nbsp;|
            ...
            <div class="column thirdColumn">
                ...
                <p>
                    <asp:GridView ID="GridViewReceipt" runat="server" AutoGenerateColumns="False">
                        <Columns>
